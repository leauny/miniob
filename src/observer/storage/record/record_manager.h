...
public:
   ...
   * @param record_size 待删除记录的record_size，为了跨页记录的删除
   * @param rid 待删除记录的标识符
   */
  RC delete_record(const RID *rid, int record_size = 1);
...
private:
  ...
  std::set<PageNum> free_pages_;  ///< 没有填充满的页面集合
