...
UpdateStmt::UpdateStmt(Table *table, const Value *values, int value_offset, FilterStmt* filterStmt)
    : table_(table), values_(values), value_offset_(value_offset), filter_stmt_(filterStmt)
{}
...
RC UpdateStmt::create(Db *db, const UpdateSqlNode &update, Stmt *&stmt)
{
  ...
  // everything alright
  stmt = new UpdateStmt(table, values, field_meta->offset(), filter_stmt);
  return RC::SUCCESS;
}
